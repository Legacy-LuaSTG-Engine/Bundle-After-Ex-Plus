...
---向量加法运算符重载
---@param a Vector4|number 第一个操作数
---@param b Vector4|number 第二个操作数
---@return Vector4 相加后的结果
...
---向量取负运算符重载
---@param v Vector4 操作数
---@return Vector4 取反后的向量
function Vector4.__unm(v)
    return Vector4.create(-v.x, -v.y, -v.z, -v.w)
end

---向量相等性比较运算符重载
---@param a Vector4 第一个操作数
---@param b Vector4 第二个操作数
